...
grid.arrange(ocp1, ocp2, ncol=2)
grid.arrange(ocp3, ocp4, ncol=2)
grid.arrange(ocp5, ocp7, ncol=2)
...
```{r Display Unspiked OCP Shewhart Chart, echo=FALSE,message=FALSE,warning=FALSE,  fig.height = 30, fig.width =7}
...
```{r Display PCB Unspike, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 30, fig.width =7}
