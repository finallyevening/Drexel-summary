...
```{r HCB plot: Running average distribution, echo=FALSE,message=FALSE,warning=FALSE,  fig.height = 60, fig.width =15}
...
avg_plot1<-ggplot(max_min_spiked_ocp, aes(x = factor(Batch_num), y = value)) + 
  ...
  geom_point(aes(color=`Batch_num`)) + 
    geom_hline(data = ocp_hline, aes(yintercept = `mean`, linetype= `linetype_mean`), color = "blue", size=0.6)+
    geom_hline(data = ocp_hline, aes(yintercept = `sd1`,linetype= `linetype_sd1`),color = "black", size=0.2)+
    geom_hline(data = ocp_hline, aes(yintercept = `sd_1`,linetype= `linetype_sd_1`),color = "black", size=0.2)+
    geom_hline(data = ocp_hline, aes(yintercept = `sd2`,linetype=`linetype_sd2`),color = "black", size=0.2)+
    geom_hline(data = ocp_hline, aes(yintercept = `sd_2`,linetype= `linetype_sd_2`),color = "black", size=0.2)+
  guides(color="none")+
  ...
  labs(y="Concentration", x = "Batch number")+
  ggtitle("QC Spiked : OCP distribution")
